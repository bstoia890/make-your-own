...
//add code for creating and positioning the third input box and button
    ...
    this.access3.position(350,390);
    this.access3.style('background', 'white');  

    this.button3 = createButton('Check');
    this.button3.position(450,420);
    ...
    display(){
       ...
       this.button1.mousePressed(() => {
           if(accessCode1 === this.access1.value()){
             this.button1.hide();
            this.access1.hide();
       ...
       this.button2.mousePressed(() => {
        if(accessCode2 === this.access2.value()){
          this.button2.hide();
         this.access2.hide();
...
this.button3.mousePressed(() => {
    if(accessCode3 === this.access3.value()){
      this.button3.hide();
     this.access3.hide();
